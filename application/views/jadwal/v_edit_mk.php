...
<div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
              <br>
              <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>kelola_jadwal/edit_mk_proses/<?php echo $this->uri->segment('3');?>">
                  <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Nama Mata kuliah</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                          <input class="form-control" name="matakuliah" value="<?php echo $db->matakuliah;?>" placeholder="Nama Mata kuliah" type="text">
                      </div>
                  </div>
                  <div class="form-group">
